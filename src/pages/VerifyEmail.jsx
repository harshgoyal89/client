...
import { signUp, sendOtp } from "../services/operations/authAPI"; // Combined imports
    ...
    <div className="grid min-h-[calc(100vh-3.51rem)] place-items-center bg-richBlack-900">
      <div className="flex max-w-[31.5rem] flex-col gap-3 p-4 md:p-8">
        ...
        <form onSubmit={handleVerifyAndSignup}>
          ...
          <Link
            to="/login"
            className="mt-4 flex items-center gap-2 text-richBlack-5"
          >
            <BsArrowLeft /> Return to login
          </Link>
          <button
            type="button" // Explicitly set the button type to avoid form submission
            className="mt-4 flex items-center gap-x-2 text-blue-100"
